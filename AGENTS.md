...
This file is the quick-reference operating contract for rustls-kotlin. The longer
...
rustls-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`rustls`](https://crates.io/crates/rustls). Upstream Rust is the behavioral oracle while the
