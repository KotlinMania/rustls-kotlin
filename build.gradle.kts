...
kotlin {
    ...
    swiftExport {
        moduleName = "Rustls"
        flattenPackage = "io.github.kotlinmania.rustls"
    }

    android {
        namespace = "io.github.kotlinmania.rustls"
        compileSdk = 34
        minSdk = 24
    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                ...
                // Upstream src/lib.rs imports `log` under the `logging` feature.
...
mavenPublishing {
    ...
    coordinates(group.toString(), "rustls-kotlin", version.toString())

    pom {
        name.set("rustls-kotlin")
        description.set("Kotlin Multiplatform port of rustls/rustls - Rustls is a modern TLS library written in Rust")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/rustls-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/rustls-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/rustls-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/rustls-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleRustlsXCFramework",
    "assembleRustlsDebugXCFramework",
    "assembleRustlsReleaseXCFramework",
    "assembleDebugIosFatFrameworkForRustlsXCFramework",
    "assembleReleaseIosFatFrameworkForRustlsXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForRustlsXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForRustlsXCFramework",
    "assembleDebugMacosFatFrameworkForRustlsXCFramework",
    "assembleReleaseMacosFatFrameworkForRustlsXCFramework",
    "assembleDebugTvosFatFrameworkForRustlsXCFramework",
    "assembleReleaseTvosFatFrameworkForRustlsXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForRustlsXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForRustlsXCFramework",
    "assembleDebugWatchosFatFrameworkForRustlsXCFramework",
    "assembleReleaseWatchosFatFrameworkForRustlsXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForRustlsXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForRustlsXCFramework",
