# rustls-kotlin in Kotlin

[![GitHub link](https://img.shields.io/badge/GitHub-KotlinMania%2Frustls--kotlin-blue.svg)](https://github.com/KotlinMania/rustls-kotlin)
[![Maven Central](https://img.shields.io/maven-central/v/io.github.kotlinmania/rustls-kotlin)](https://central.sonatype.com/artifact/io.github.kotlinmania/rustls-kotlin)
[![Build status](https://img.shields.io/github/actions/workflow/status/KotlinMania/rustls-kotlin/ci.yml?branch=main)](https://github.com/KotlinMania/rustls-kotlin/actions)

This is a Kotlin Multiplatform line-by-line transliteration port of [`rustls/rustls`](https://github.com/rustls/rustls).

**Original Project:** This port is based on [`rustls/rustls`](https://github.com/rustls/rustls). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
## Upstream README — `rustls/rustls`

> The text below is reproduced and lightly edited from [`https://github.com/rustls/rustls`](https://github.com/rustls/rustls). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
We have a [roadmap](https://github.com/rustls/rustls/blob/HEAD/ROADMAP.md) for our future plans. We also have [benchmarks](https://github.com/rustls/rustls/blob/HEAD/BENCHMARKING.md) to
prevent performance regressions and to let you evaluate rustls on your target hardware.

If you'd like to help out, please see [CONTRIBUTING.md](https://github.com/rustls/rustls/blob/HEAD/CONTRIBUTING.md).
...
This Kotlin port is distributed under the same Apache-2.0 license as the upstream [`rustls/rustls`](https://github.com/rustls/rustls). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.

Original work copyrighted by the rustls authors.  
Kotlin port: Copyright (c) 2026 Sydney Renee and The Solace Project.

### Acknowledgments

Thanks to the [`rustls/rustls`](https://github.com/rustls/rustls) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
