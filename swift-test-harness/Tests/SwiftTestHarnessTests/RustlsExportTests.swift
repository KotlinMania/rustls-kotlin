...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Rustls.swiftmodule/`
...
//      `import Rustls` above would fail at compile time.
//
//   2. The static archive `libRustls.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Rustls" }` and
//      `flattenPackage = "io.github.kotlinmania.rustls"` configuration in
...
final class RustlsExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Rustls swift module imported cleanly")
    }
}
